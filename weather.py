...
def getWeather():
    try:
        ...
        #weather 
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=a8c47e82708a261fc81ca2a2816fb519"
        ...
        if "rain" in description.lower():
            background_label.config(image=rainy_image)
        elif "clear" in description.lower():
            background_label.config(image=clear_image)
